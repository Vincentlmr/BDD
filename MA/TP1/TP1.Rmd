...
set.seed(1234)
sigma =matrix(c(0.7,0,1.3,0.5,0,1.2,-0.3,-0.1,1.3,-0.3,3.1,1.3,0.5,-0.1,1.3,0.6), nrow = p, ncol = p, byrow = TRUE)
...
colMeans(X)
```
On remarque que le colMean est proche de $\mu$
...
fviz_eig(ACP.X,choice = "eigenvalue", addlabels = TRUE )+
geom_hline (yintercept = 1, linetype = 2, color = "red")
```
On garde 2 dimensions
...
NIPALS <- function(X, h = 2, iter = 100) {
  ...
  #na.rm permet de ne pas prendre en compte les NA
